...
namespace QMC.CDT_320.Ui
{
    ...
    public static class UiTheme
    {
        ...
        public static readonly Color DotVision          = Color.FromArgb(0x00, 0xBC, 0xD4); // cyan
        public static readonly Color DotPick            = Color.FromArgb(0xF5, 0xC7, 0x18); // yellow
        public static readonly Color DotReference       = Color.FromArgb(0xBD, 0xBD, 0xBD); // gray
