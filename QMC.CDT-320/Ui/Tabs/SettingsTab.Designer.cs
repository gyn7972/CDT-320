...
namespace QMC.CDT_320.Ui.Tabs
{
    partial class SettingsTab
    {
        ...
        {
            this.BtnGeneral = new SidebarButton();
            ...
            this.BtnLightSource = new SidebarButton();
            this.PnlSecondarySeparator = new System.Windows.Forms.Panel();
            this.BtnBarcode = new SidebarButton();
            this.BtnZoomLens = new SidebarButton();
            this.BtnHeightSensor = new SidebarButton();
            this.BtnSimulator = new SidebarButton();
            this.BtnVisionLink = new SidebarButton();
            this.BtnSelfTest = new SidebarButton();
            this.BtnAlarmMaster = new SidebarButton();
            this.BtnTeach = new SidebarButton();
            this.BtnAxisSetup = new SidebarButton();
            this.BtnCameraSetup = new SidebarButton();
            this.BtnLightSetup = new SidebarButton();
            this.BtnRemoteViewer = new SidebarButton();
            this.SuspendLayout();
            // 
            // BtnGeneral
            // 
