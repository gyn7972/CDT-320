...
namespace QMC.CDT_320.Ui.Pages.WorkInfo
{
    partial class OutputFeederPage
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.targetSideLayout = new TableLayoutPanel();
            this.rbTargetOk = new RadioButton();
            this.rbTargetNg = new RadioButton();
            ...
            this.workLayout.RowStyles.Add(new RowStyle(SizeType.Absolute, 36F));
            this.workLayout.RowStyles.Add(new RowStyle(SizeType.Absolute, 36F));
            this.workLayout.Size = new Size(254, 164);
            ...
            this.lblTargetCaption.BackColor = Color.FromArgb(208, 208, 208);
            this.lblTargetCaption.Dock = DockStyle.Fill;
            this.lblTargetCaption.Font = new Font("留묒? 怨좊뵓", 10F, FontStyle.Bold);
            this.lblTargetCaption.Padding = new Padding(6, 0, 0, 0);
            this.lblTargetCaption.Text = "TARGET";
            this.lblTargetCaption.TextAlign = ContentAlignment.MiddleLeft;
            this.targetSideLayout.BackColor = Color.White;
            this.targetSideLayout.ColumnCount = 2;
            this.targetSideLayout.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 50F));
            this.targetSideLayout.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 50F));
            this.targetSideLayout.Controls.Add(this.rbTargetOk, 0, 0);
            this.targetSideLayout.Controls.Add(this.rbTargetNg, 1, 0);
            this.targetSideLayout.Dock = DockStyle.Fill;
            this.targetSideLayout.RowCount = 1;
            this.targetSideLayout.RowStyles.Add(new RowStyle(SizeType.Percent, 100F));
            this.rbTargetOk.Checked = true;
            this.rbTargetOk.Dock = DockStyle.Fill;
            this.rbTargetOk.Font = new Font("Consolas", 10F, FontStyle.Bold);
            this.rbTargetOk.Text = "OK";
            this.rbTargetOk.TextAlign = ContentAlignment.MiddleCenter;
            this.rbTargetOk.UseVisualStyleBackColor = true;
            this.rbTargetNg.Dock = DockStyle.Fill;
            this.rbTargetNg.Font = new Font("Consolas", 10F, FontStyle.Bold);
            this.rbTargetNg.Text = "NG";
            this.rbTargetNg.TextAlign = ContentAlignment.MiddleCenter;
