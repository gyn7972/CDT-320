namespace QMC.CDT_320.Ui.Pages.Recipe
{
    partial class VisionRecipePage
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.rdoMain.AutoSize = this.rdoChip.AutoSize = this.rdoSub.AutoSize = this.rdoCross.AutoSize = this.rdoIndex1.AutoSize = this.rdoIndex2.AutoSize = this.rdoIndex4.AutoSize = this.rdoIndex8.AutoSize = true;
            this.rdoMain.Dock = this.rdoChip.Dock = this.rdoSub.Dock = this.rdoCross.Dock = this.rdoIndex1.Dock = this.rdoIndex2.Dock = this.rdoIndex4.Dock = this.rdoIndex8.Dock = System.Windows.Forms.DockStyle.Fill;
            this.rdoMain.Font = this.rdoChip.Font = this.rdoSub.Font = this.rdoCross.Font = this.rdoIndex1.Font = this.rdoIndex2.Font = this.rdoIndex4.Font = this.rdoIndex8.Font = new System.Drawing.Font("맑은 고딕", 9F, System.Drawing.FontStyle.Bold);
            ...
            this.scaleXPair.ColumnCount = this.scaleYPair.ColumnCount = this.pitchPair.ColumnCount = this.scalePair.ColumnCount = 2;
            ...
            this.scaleXPair.Dock = this.scaleYPair.Dock = this.pitchPair.Dock = this.scalePair.Dock = System.Windows.Forms.DockStyle.Fill;
            this.scaleXPair.RowCount = this.scaleYPair.RowCount = this.pitchPair.RowCount = this.scalePair.RowCount = 1;
            ...
            // common styling
            // 
            this.lblScaleXKey.BackColor = this.lblScaleYKey.BackColor = this.lblPitchKey.BackColor = this.lblScaleKey.BackColor = System.Drawing.Color.FromArgb(208, 208, 208);
            this.lblScaleXValue.BackColor = this.lblScaleYValue.BackColor = this.lblPitchValue.BackColor = this.lblScaleValue.BackColor = System.Drawing.Color.White;
            this.lblScaleXKey.BorderStyle = this.lblScaleYKey.BorderStyle = this.lblPitchKey.BorderStyle = this.lblScaleKey.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
            this.lblScaleXValue.BorderStyle = this.lblScaleYValue.BorderStyle = this.lblPitchValue.BorderStyle = this.lblScaleValue.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
            this.lblScaleXKey.Dock = this.lblScaleYKey.Dock = this.lblPitchKey.Dock = this.lblScaleKey.Dock = System.Windows.Forms.DockStyle.Fill;
            this.lblScaleXValue.Dock = this.lblScaleYValue.Dock = this.lblPitchValue.Dock = this.lblScaleValue.Dock = System.Windows.Forms.DockStyle.Fill;
            this.lblScaleXKey.Font = this.lblScaleYKey.Font = this.lblPitchKey.Font = this.lblScaleKey.Font = new System.Drawing.Font("맑은 고딕", 9F, System.Drawing.FontStyle.Bold);
            this.lblScaleXValue.Font = this.lblScaleYValue.Font = this.lblPitchValue.Font = this.lblScaleValue.Font = new System.Drawing.Font("Consolas", 9.5F, System.Drawing.FontStyle.Bold);
            this.lblScaleXKey.TextAlign = this.lblScaleYKey.TextAlign = this.lblPitchKey.TextAlign = this.lblScaleKey.TextAlign = System.Drawing.ContentAlignment.MiddleLeft;
            this.lblScaleXValue.TextAlign = this.lblScaleYValue.TextAlign = this.lblPitchValue.TextAlign = this.lblScaleValue.TextAlign = System.Drawing.ContentAlignment.MiddleRight;
            this.btnGrab.Dock = this.btnMatch.Dock = this.btnFastShutter.Dock = this.btnSmallRoi.Dock = this.btnMatchMove.Dock = this.btnImageSave.Dock = this.btnThetaMatchMove.Dock = this.btnJogYPlus.Dock = this.btnJogXMinus.Dock = this.btnJogStop.Dock = this.btnJogXPlus.Dock = this.btnJogYMinus.Dock = this.btnJogTMinus.Dock = this.btnJogTPlus.Dock = System.Windows.Forms.DockStyle.Fill;
            this.btnGrab.Font = this.btnMatch.Font = this.btnFastShutter.Font = this.btnSmallRoi.Font = this.btnMatchMove.Font = this.btnImageSave.Font = this.btnThetaMatchMove.Font = this.btnJogYPlus.Font = this.btnJogXMinus.Font = this.btnJogStop.Font = this.btnJogXPlus.Font = this.btnJogYMinus.Font = this.btnJogTMinus.Font = this.btnJogTPlus.Font = new System.Drawing.Font("맑은 고딕", 9F, System.Drawing.FontStyle.Bold);
            this.btnGrab.Margin = this.btnMatch.Margin = this.btnFastShutter.Margin = this.btnSmallRoi.Margin = this.btnMatchMove.Margin = this.btnImageSave.Margin = this.btnThetaMatchMove.Margin = this.btnJogYPlus.Margin = this.btnJogXMinus.Margin = this.btnJogStop.Margin = this.btnJogXPlus.Margin = this.btnJogYMinus.Margin = this.btnJogTMinus.Margin = this.btnJogTPlus.Margin = new System.Windows.Forms.Padding(4);
            // 
            // VisionRecipePage
            // 
