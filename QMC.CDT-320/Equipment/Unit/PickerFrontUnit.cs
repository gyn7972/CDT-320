...
namespace QMC.CDT320
{
    ...
    public sealed class PickerAlignOffset
    {
        ...
        public static PickerAlignOffset[] CreateArray(int count)
        {
            PickerAlignOffset[] offsets = new PickerAlignOffset[count];
            for (int i = 0; i < offsets.Length; i++)
                offsets[i] = new PickerAlignOffset();
            return offsets;
        }
    }
    ...
    public sealed class PickerFrontConfig : IConfigData
    {
        ...
        public void EnsureArrays()
        {
            if (UsePicker == null || UsePicker.Length < PickerFrontUnit.MaxPickerCount)
            {
    ...
    public sealed class PickerAxisPositionSet
    {
        ...
        public void EnsureArrays()
        {
            if (DiePickPosition == null) DiePickPosition = new double[0];
            if (DieBottomPosition == null) DieBottomPosition = new double[0];
    ...
    public class PickerFrontUnit : BaseUnit<PickerFrontSetup, PickerFrontConfig, PickerFrontRecipe>, IUnitJogController
    {
        ...
        {
            return side == "Rear" ? "RearPicker" + pickerNo + "_Vacuum" : "FrontPicker" + pickerNo + "Vacuum";
        }

        private string BuildBlowName(int pickerNo)
        {
            return side == "Rear" ? "RearPicker" + pickerNo + "_Blow" : "FrontPicker" + pickerNo + "Blow";
        }
        ...
        public Task<int> MoveToFrontPickerAvoidPosition(bool bFine = false)
        {
        ...
        public Task<int> MoveToFrontPickerDiePickPosition(int pickerNo, bool bFine = false)
        {
            return MoveToPickerDiePickPosition(pickerNo, bFine);
        }

        public Task<int> MoveToFrontPickerDieProcessPosition(int pickerNo, bool bFine = false)
        {
            return MoveToPickerDieProcessPosition(pickerNo, bFine);
        }

        public Task<int> MoveToFrontPickerDiePlacePosition(int pickerNo, bool bFine = false)
        {
            return MoveToPickerDiePlacePosition(pickerNo, bFine);
        }

        public Task<int> MoveFrontPickerZToPickHeight(int pickerNo, bool bFine = false)
        {
            return MovePickerZToPickHeight(pickerNo, bFine);
        }

        public Task<int> MoveFrontPickerZToSafeHeight(int pickerNo, bool bFine = false)
        {
            return MovePickerZToSafeHeight(pickerNo, bFine);
        }

        public Task<int> MoveFrontPickerTToOffset(int pickerNo, bool bFine = false)
        {
            return MovePickerTToOffset(pickerNo, bFine);
        }

        public bool IsFrontPickerAxisInPosition(PickerAxis axis, double targetPos, double tolerance)
        {
            return IsPickerAxisInPosition(axis, targetPos, tolerance);
        }

        public Task<bool> WaitFrontPickerAxisMoveDone(PickerAxis axis, int timeoutMs)
        {
            return WaitPickerAxisMoveDone(axis, timeoutMs);
        }

        public Task<bool> WaitFrontPickerAxesMoveDone(IEnumerable<PickerAxis> targetAxes, int timeoutMs)
        {
            return WaitPickerAxesMoveDone(targetAxes, timeoutMs);
        }

        public bool IsFrontPickerAxisInTeachingPosition(PickerAxis axis, string positionName)
        {
            return IsPickerAxisInTeachingPosition(axis, positionName);
        }

        public Task<bool> WaitFrontPickerAxisInTeachingPosition(PickerAxis axis, string positionName, int timeoutMs)
        {
            return WaitPickerAxisInTeachingPosition(axis, positionName, timeoutMs);
        }

        public bool IsFrontPickerInAvoidPosition()
        {
        ...
        public bool IsFrontPickerInDieProcessPosition(int pickerNo)
        {
            return IsPickerInDieProcessPosition(pickerNo);
        }

        public bool IsFrontPickerInDiePlacePosition(int pickerNo)
        {
            return IsPickerInDiePlacePosition(pickerNo);
        }

        public void TeachFrontPickerAxisPosition(PickerAxis axis, string positionName)
        {
            TeachPickerAxisPosition(axis, positionName);
        }

        public void TeachFrontPickerAvoidPositions()
        {
        ...
        public void TeachFrontPickerDiePickPosition(int pickerNo)
        {
            TeachPickerDiePickPosition(pickerNo);
        }

        public void TeachFrontPickerDieProcessPosition(int pickerNo)
        {
            TeachPickerDieProcessPosition(pickerNo);
        }

        public void TeachFrontPickerDiePlacePosition(int pickerNo)
        {
            TeachPickerDiePlacePosition(pickerNo);
        }

        public void TeachFrontPickerOffsetPosition(int pickerNo)
        {
            TeachPickerOffsetPosition(pickerNo);
        }

        public double GetFrontPickerTeachingPosition(PickerAxis axis, string positionName)
        {
            return GetPickerTeachingPosition(axis, positionName);
        }

        public bool ValidateFrontPickerTeachingComplete()
        {
