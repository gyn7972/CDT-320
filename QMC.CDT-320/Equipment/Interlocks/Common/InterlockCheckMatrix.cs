    ...
    public sealed class InterlockCheckMatrix
    {
        ...
        private static readonly Dictionary<string, string> Aliases =
            new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
            {
                ...
                { "CameraX", "InputVisionX" },
                { "NeedleBlockX", "NeedleX" },
                { "WaferY", "WaferStageY" },
                { "WaferT", "WaferStageT" },
                { "GoodBinY", "OutputGoodStageY" },
                { "GoodBinZ", "OutputGoodStageZ" },
                { "NgBinY", "OutputNGStageY" },
                ...
                { "ReticleLift", "ReticleLift" },
                { "ReticleSideSlideFront", "ReticleSideSlideFront" },
                { "ReticleSideSlideRear", "ReticleSideSlideRear" },
                ...
                { "OutputFeeder Up/Down", "OutputFeederLift" },
                { "OutputFeeder Clamp/UnClamp", "OutputFeederClamp" }
            };
        ...
        private static InterlockCheckPair[] CreateDefaultPairs()
        {
            return new[]
            {
                P("InputLifterZ", "InputFeederY", "E8"),
                P("InputLifterZ", "Feeder Up/Down", "F8"),
                P("InputLifterZ", "Feeder Clamp/UnClamp", "G8"),
                P("InputLifterZ", "InputVisionX", "K8"),
                P("InputFeederY", "InputLifterZ", "D9"),
                P("InputFeederY", "Feeder Up/Down", "F9"),
                P("InputFeederY", "Feeder Clamp/UnClamp", "G9"),
                P("InputFeederY", "WaferY", "H9"),
                P("InputFeederY", "WaferT", "I9"),
                P("InputFeederY", "WaferExpandingZ", "J9"),
                P("Feeder Up/Down", "InputLifterZ", "D10"),
                P("Feeder Up/Down", "InputFeederY", "E10"),
                ...
                P("WaferT", "InputFeederY", "E13"),
                P("WaferT", "Feeder Up/Down", "F13"),
                P("WaferExpandingZ", "InputFeederY", "E14"),
                P("WaferExpandingZ", "Feeder Up/Down", "F14"),
                P("InputVisionX", "InputFeederY", "E15"),
                P("InputVisionX", "FrontPickerX", "R15"),
                P("InputVisionX", "RearPickerX", "AD15"),
                ...
                P("FrontPickerX", "InputFeederY", "E22"),
                P("FrontPickerX", "InputVisionX", "K22"),
                ...
                P("NgBinY", "OutputFeederY", "AX46"),
                P("NgBinY", "OutputFeeder Up/Down", "AY46"),
                P("NgBinY", "OutputFeeder Clamp/UnClamp", "AZ46"),
                P("OutputVisionX", "FrontPickerX", "R47"),
                P("OutputVisionX", "RearPickerX", "AD47"),
                P("OutputFeederY", "FrontPickerX", "R54"),
                P("OutputFeederY", "RearPickerX", "AD54"),
                P("OutputFeederY", "OutputVisionX", "AQ54"),
                P("OutputFeederY", "OutputFeeder Up/Down", "AY54"),
                P("OutputFeederY", "OutputFeeder Clamp/UnClamp", "AZ54"),
                P("OutputFeederY", "OutputLifterZ", "BA54"),
                P("OutputFeeder Up/Down", "OutputFeederY", "AX55"),
                P("OutputFeeder Up/Down", "OutputFeeder Clamp/UnClamp", "AZ55"),
                P("OutputFeeder Up/Down", "OutputLifterZ", "BA55"),
                P("OutputFeeder Clamp/UnClamp", "OutputFeederY", "AX56"),
                P("OutputFeeder Clamp/UnClamp", "OutputFeeder Up/Down", "AY56"),
                P("OutputFeeder Clamp/UnClamp", "OutputLifterZ", "BA56"),
                P("OutputLifterZ", "OutputFeederY", "AX57"),
                P("OutputLifterZ", "OutputFeeder Up/Down", "AY57"),
