...
namespace QMC.Common.Motion.Ajin
{
    ...
    {
        Busy = 0x0000001,     // Bit 0, BUSY(드라이브 구동 중)
        Decelerating = 0x0000002,     // Bit 1, DOWN(감속 중)
        UniformMotion = 0x0000004,     // Bit 2, CONST(등속 중)
        Accelerating = 0x0000008,     // Bit 3, UP(가속 중)
        ...
        Direction = 0x0000800,     // Bit 11, 현재 구동 드라이브 방향(보간 드라이브에서는 표시 정보 다름)
