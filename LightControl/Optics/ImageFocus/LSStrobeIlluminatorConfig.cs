...
{
    [Serializable]
    public enum ParamLSStrobeIlluminatorKey
    {
        PortName,
        BaudRate,
        DataBits,
    ...
    [Serializable]
    public class LSStrobeIlluminatorConfig : IlluminatorConfig
    {
        #region Property
        ...
        #endregion
        public LSStrobeIlluminatorConfig() : base()
        {
            ControllerType = IlluminatorControllerType.LSStrobe;
            PortName = "COM1";
            BaudRate = 9600;
            DataBits = 8;
        ...
        public override void SetParam(ListParam listParam)
        {
            ...
            {
                Param param = null;
                param = group.GetParam((int)ParamLSStrobeIlluminatorKey.PortName);
                if (param != null)
                {
                ...
                param = group.GetParam((int)ParamLSStrobeIlluminatorKey.BaudRate);
                if (param != null)
                {
                    int value = 0;
                ...
                param = group.GetParam((int)ParamLSStrobeIlluminatorKey.DataBits);
                if (param != null)
                {
                    int value = 0;
                    if (param.GetIntValue(ref value))
                ...
                param = group.GetParam((int)ParamLSStrobeIlluminatorKey.StopBits);
                if (param != null)
                {
                    int value = 0;
                    if (param.GetIntValue(ref value))
                ...
                param = group.GetParam((int)ParamLSStrobeIlluminatorKey.Parity);
                if (param != null)
                {
                    int value = 0;
                    if (param.GetIntValue(ref value))
                ...
                param = group.GetParam((int)ParamLSStrobeIlluminatorKey.Handshake);
                if (param != null)
                {
                    int value = 0;
                    if (param.GetIntValue(ref value))
                ...
                param = group.GetParam((int)ParamLSStrobeIlluminatorKey.TimeOut);
                if (param != null)
                {
                    int value = 0;
                    if (param.GetIntValue(ref value))
