...
namespace QMC.Vision.Ui.Pages
{
    partial class InspectorTargetPage
    {
        ...
        private void InitializeComponent()
        {
            ...
            this._left.ColumnCount = 1; this._left.RowCount = 5; this._left.Margin = Padding.Empty;
            ...
            this._left.RowStyles.Add(new RowStyle(SizeType.Absolute, 40f));
            this._left.Controls.Add(this._secCam, 0, 0);
            this._left.Controls.Add(this._cam, 0, 1);
            this._left.Controls.Add(this._secResult, 0, 2);
            this._left.Controls.Add(this._result, 0, 3);
            this._left.Controls.Add(this._lblVerdict, 0, 4);

            // ── 중 액션 (INSPECT span + LOAD/이미지저장/EDIT ROI) ──
            ...
            this._actionPanel.ColumnCount = 2; this._actionPanel.RowCount = 3;
            ...
            this._actionPanel.RowStyles.Add(new RowStyle(SizeType.Percent, 30f));
            this._actionPanel.RowStyles.Add(new RowStyle(SizeType.Percent, 30f));
            ...
            this._center.ColumnCount = 1; this._center.RowCount = 2; this._center.Margin = Padding.Empty;
